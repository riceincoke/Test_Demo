...
import com.blog.admin.respository.blog.reposity.ESBlogRepo;
...
public class EsController {
    ...
    @ResponseBody
    public List<ESBlog> findBlog(String tle , String su, String con) {
        init();
        Page<ESBlog> page = esBlogRepo.findDistinctESBlogByTitleContainingOrSummaryContainingOrContentContaining(tle,su,con, new PageRequest(0, 20));
        return page.getContent();
    }

    @GetMapping(value = "/blogs")
    @ResponseBody
    public List<ESBlog> findBlogs() {
        init();
        Page<ESBlog> blogPage = esBlogRepo.findAll(new PageRequest(0, 5));
